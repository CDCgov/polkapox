...
include { VARIANT_CONVERT                               } from '../../modules/local/variant_convert/variant_convert'
include { SAMTOOLS_SORT                                 } from '../../modules/nf-core/samtools/sort/main'
include { SAMTOOLS_FLAGSTAT                             } from '../../modules/nf-core/samtools/flagstat/main'
include { SAMTOOLS_DEPTH                                } from '../../modules/nf-core/samtools/depth/main'
include { VCFTOOLS as VCFTOOLS_IVAR                     } from '../../modules/nf-core/vcftools/main'
include { SUMMARIZE_TSV                                 } from '../../modules/local/summarize_tsv/summarize_tsv'
include { AGGREGATE_TSVS                                } from '../../modules/local/aggregate_tsvs/aggregate_tsvs'
